...
from dataportal.models import Pulsars, Targets, Telescopes, Programs, Projects, Instrumentconfigs, Observations, \
    Pipelines, Processings, Ephemerides, Pulsartargets, Foldings, Filterbankings, Pipelineimages
