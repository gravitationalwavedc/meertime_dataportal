...
from dataportal.graphql import project_membership_queries
...
class Query(
    dataportal_queries.Query, user_manage_queries.Query, project_membership_queries.Query, graphene.ObjectType
):
    pass
