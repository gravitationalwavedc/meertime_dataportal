            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="observation_summaries",
                        to="dataportal.calibration",
                    ),
                ),
                (
                    "project",
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to="dataportal.project"),
                ),
                (
                    "pulsar",
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to="dataportal.pulsar"),
                ),
                (
                    "telescope",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.CASCADE, to="dataportal.telescope"
                    ),
                ),
            ],
            options={
