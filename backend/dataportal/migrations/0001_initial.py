    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "calibration_type",
                    models.CharField(choices=[("pre", "pre"), ("post", "post"), ("none", "none")], max_length=4),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "obs_type",
                    models.CharField(choices=[("cal", "cal"), ("fold", "fold"), ("search", "search")], max_length=6),
                ),
                ...
                (
                    "calibration",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.calibration"
                    ),
                ),
                (
                    "ephemeris",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ephemeris",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.ephemeris"
                    ),
                ),
                (
                    "observation",
                    models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.observation"),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "main_project",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.mainproject"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "comment",
                    models.TextField(
                        help_text="Auto generated description based on information from the ANTF catalogue", null=True
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        ...
                        upload_to=dataportal.storage.get_template_upload_location,
                    ),
                ),
                ...
                (
                    "project",
                    models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.project"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ephemeris",
                    models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.ephemeris"),
                ),
                (
                    "pipeline_run",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="toas",
                        to="dataportal.pipelinerun",
                    ),
                ),
                (
                    "template",
                    models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.template"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "toa",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="residuals", to="dataportal.toa"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "main_project",
                    models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.mainproject"),
                ),
                ("pulsar", models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.pulsar")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "observation",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="dataportal.observation"),
                ),
                (
                    "pipeline_run",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="dataportal.pipelinerun"),
                ),
                ("pulsar", models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.pulsar")),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pipeline_run",
                    models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.pipelinerun"),
                ),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("pulsar", "project", "band", "template_hash"),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("pulsar_fold_result", "image_type", "cleaned", "resolution"),
        ...
        migrations.AddConstraint(
            model_name="ephemeris",
            constraint=models.UniqueConstraint(
                fields=("project", "ephemeris_hash"), name="Unique ephemeris for each project"
            ),
        ),
    ]
