    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "folding_ephemeris",
                    models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.Ephemerides"),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "calibration",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.Calibrations"
                    ),
                ),
                (
                    "instrument_config",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.Instrumentconfigs"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "observation",
                    models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.Observations"),
                ),
                (
                    "parent",
                    models.ForeignKey(
                        ...
                        to="dataportal.Processings",
                    ),
                ),
                (
                    "pipeline",
                    models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.Pipelines"),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quality",
                    models.IntegerField(blank=True, choices=[("nominal", "nominal"), ("bad", "bad")], null=True),
                ),
                ("comment", models.CharField(blank=True, max_length=255, null=True)),
                (
                    "input_folding",
                    models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.Foldings"),
                ),
                (
                    "processing",
                ...
                (
                    "template",
                    models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.Templates"),
                ),
                (
                    "timing_ephemeris",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.Ephemerides"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "collection",
                    models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.Collections"),
                ),
                (
                    "processing",
                    models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to="dataportal.Processings"),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="parent_pipeline",
                        to="dataportal.Pipelines",
                    ),
                ),
                (
                    "pipeline",
