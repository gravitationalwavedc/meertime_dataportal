...
describe("card list component", () => {
  ...
  const columns = [
    ...
    {
      dataField: "avgSnr5min",
      text: "Avg S/N pipe (5 mins)",
      align: "right",
      headerAlign: "right",
      sort: true,
    },
    {
      dataField: "maxSnr5min",
      text: "Max S/N pipe (5 mins)",
      align: "right",
      headerAlign: "right",
      sort: true,
    },
  ...
  it("should display data without a search term", () => {
    ...
    const { getByText } = render(
      <JobCardsList data={data} columns={columns} search={{ searchText: "" }} />
    );
