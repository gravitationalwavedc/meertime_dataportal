              ...
              <Card.Body className="m-4">
                ...
                {loadState === "complete" && (
                  <div>
                    ...
                    <div>
                      Your email address has been verified successfully. You
                      should be able to login to the system using the login
                      page. Please follow the login link below to access it.
                    </div>
                ...
                {loadState === "error" && (
                  <div>
                    ...
                    <div>
                      We cannot verify your email due the error:
                      <br />
