            ...
            environment,
            {
                ...
                onCompleted: ({ accountActivation }) => {
                    if (accountActivation.errors) {
                        ...
                        // console.log(accountActivation.errors); // eslint-disable-line no-console
                            ...
                            <Card.Body className="m-4">
                                ...
                                {success &&
                                    <div>
                                        ...
                                        <div>Your account has been activated successfully. You need to login using your
                                ...
                                {!success &&
                                    <Formik
                                        ...
                                        onSubmit={(values) => accountActivation(
                                            values.first_name,
                                            values.last_name,
                                            values.email,
                                            values.password,
                                                    ...
                                                    <Field name="activation_code">
                                                        {({ field, meta }) =>
                                                            <Form.Group
                                                                ...
                                                                <Form.Label>Code (will be matched against your
                                                                email)</Form.Label>
                                                                <Form.Control
                                                                    {...field}
                                                    ...
                                                    <Field name="email">
                                                        {({ field, meta }) =>
                                                            <Form.Group
                                                                controlId="email"
                                                                as={Col} sm={12} md={12} xl={12}>
                                                                <Form.Label>Email (to which address the link was
                                                                    sent)</Form.Label>
                                                                <Form.Control
                                                                    {...field}
                                                                    isInvalid={meta.touched && meta.error}/>
                                                ...
                                                <Row className="buttons-row">
                                                    <Col xl={{ span: 12 }} md={{ span: 12 }}>
                                                        <Button
                                                            ...
                                                            type="submit">Activate With Password</Button>
                                                    </Col>
                                                </Row>
                                            </Form>}
                                    </Formik>}
