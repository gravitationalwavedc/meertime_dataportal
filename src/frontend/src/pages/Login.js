...
import { Alert, Container, Form, InputGroup, Col, Row, Button, Card } from 'react-bootstrap';
                  ...
                  <Form>
                      <Field name="username"> 
                        ...
                        <Form.Group controlId="username">
                          ...
                          <Form.Control {...field} isInvalid={meta.touched && meta.error} />
                      ...
                      <Form.Group controlId="password">
                        ...
                        <Form.Control type="password" {...field} isInvalid={meta.touched && meta.error}/>
                        {!meta.error && <HiOutlineLockClosed className="form-control-icon-right" />}
                        <Form.Control.Feedback type='invalid'>{meta.error}</Form.Control.Feedback>
                      </Form.Group>}
                      </Field>
                    { formErrors && formErrors.map((e) => <Alert variant='danger' key={e}>{e}</Alert>)}
                    <Button className="text-uppercase shadow-md mt-2" onClick={handleSubmit}>Sign in</Button>
                  </Form>}
                </Formik>
              </Card.Body>
            </Card>
