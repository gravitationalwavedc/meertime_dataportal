...
class IndexView(generic.ListView):
    ...
    def get_queryset(self):
        ...
        raw_query = "SELECT o.pulsar_id, o.beam, "+\
                ...
                "Observations.proposal_id = Proposals.id "+ proposal_filter +\
...
class DetailView(generic.ListView):
    ...
    def get_queryset(self):
        ...
        return Observations.objects.filter(pulsar=pulsar).values('utc__utc',
            'proposal__proposal_short', 'length', 'beam', 'nchan', 'nbin',
            'nant', 'dm_fold', 'dm_pipe', 'rm_pipe', 'snr_spip',
            'snr_pipe').order_by('-utc__utc_ts')
